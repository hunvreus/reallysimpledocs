...
Install htmx first, or use the CDN script shown below:
...
If you prefer the CDN, keep the same sidebar sync script and replace the final htmx script tag with:
