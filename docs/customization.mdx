...
Individual pages can override the metadata title and description with frontmatter:
...
`title` replaces the H1-derived page title for the layout and metadata. `description` replaces `site.description` for that page.
